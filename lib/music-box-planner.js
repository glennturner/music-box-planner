...
MusicBoxPlanner.prototype._getDataFromCalendarDayBlock = function (block) {
  ...
  block.querySelectorAll('.programming-content').forEach(film => {
    ...
    film.querySelectorAll('.times a').forEach(ele => {
...
MusicBoxPlanner.prototype._getStartTimeFromCalendarDayBlock = function (day) {
  console.log('GET CALENDAR DAY BLOCK')
}
